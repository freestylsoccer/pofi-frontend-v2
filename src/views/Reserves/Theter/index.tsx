...
const Theter: React.FC = () => {
  ...
  const { aTokenBalance, balanceFetchStatus } = useReserveUserDeposited(PROTOCOL_DATA_PROVIDER_ADDRESS, PROJECT_USDT, account)
            ...
            <div className="container content-end">
              ...
              <div>
                <div className="pb-3">
                  ...
                  <Title>${`${projectTotalDeposited.toLocaleString('en-US')} USDT`}</Title>
                  <NormalText>
                    <NormalTextSpanIII>You have deposited: </NormalTextSpanIII>
                    <NormalTextSpanIII>${`${getBalanceNumber(aTokenBalance, decimals).toLocaleString('en-US')} USDT`}</NormalTextSpanIII>
                  </NormalText>
                </div>
              </div>
            </div>
