...
const TrueUsd: React.FC = () => {
  ...
  const { aTokenBalance, balanceFetchStatus } = useReserveUserDeposited(PROTOCOL_DATA_PROVIDER_ADDRESS, PROJECT_TUSD, account)
            ...
            <div className="container content-end">
              ...
              <div>
                <div className="pb-3">
                  ...
                  <Title>${`${projectTotalDeposited.toLocaleString('en-US')} TUSD`}</Title>
                  <NormalText>
                    <NormalTextSpanIII>You have deposited: </NormalTextSpanIII>
                    <NormalTextSpanIII>${`${getBalanceNumber(aTokenBalance, decimals).toLocaleString('en-US')} TUSD`}</NormalTextSpanIII>
                  </NormalText>
                </div>
              </div>
            </div>
